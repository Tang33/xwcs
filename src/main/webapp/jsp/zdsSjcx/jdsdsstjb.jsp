		...
		<div class="layui-form" lay-filter="test1">
			...
			<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
				...
				<table class="layui-table" id="table" lay-filter="user">
					<thead>
						<tr>
							<th style="text-align:center" lay-data="{field:'ROWNUM'}">街道</th>
							<th style="text-align:center" lay-data="{field:'GNDM'}">一般企业</th>
							<th style="text-align:center" lay-data="{field:'GNMC'}">房地产企业</th>
							<th style="text-align:center" lay-data="{field:'PX'}">亿元企业</th>
							<th style="text-align:center" lay-data="{field:'URL'}">合计</th>
							<th style="text-align:center" lay-data="{field:'LRRQ'}">比重</th>
						</tr>
					</thead>
					<tbody id="ttbody">
...
<script>
		...
		layui.use(['form', 'layedit', 'laydate','laypage'], function() {
			...
			ajax({
				url:"ajax.do?ctrl=jdsdsstjb_queryInit",
				data:{},
				type:'post',
			...
			form.on('submit(export)',function(){
				...
				window.location.href="export.do?ctrl=jdsdsstjb_export&cxrq="
						+cxrq+"&jd_dm="+jd_dm;
			});
		...
		function getData() {
			...
			showLoad();
			ajax({
				url:"ajax.do?ctrl=jdsdsstjb_queryJdsd",
				data:{
					"pageNo":pageNo,
					"pageSize":pageSize,
					"cxrq":cxrq,
