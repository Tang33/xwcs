...
<body style="overflow-x: hidden">
												...
												<div class="layui-col-md7">
													...
													<div class="layui-input-block">
														<select name="sortname" id="sortname" style="width: 40%;">
															...
															<option value="JD_DM">街道名称</option>
				...
				<table class="layui-table" id="table" lay-filter="user">
					<thead>
						<tr>
							...
							<th lay-data="{field:'GNMC'}">街道（园区）</th>
							<th lay-data="{field:'PX'}">户数</th>
							<th lay-data="{field:'URL'}">本年截止当月税收</th>
							<th lay-data="{field:'SSTBZJE'}">同比增减额</th>
							<th lay-data="{field:'SSTBZJL'}">同比增减率</th>
							<th lay-data="{field:'PX'}">上年全年税收</th>
						</tr>
					</thead>
					<tbody id="ttbody">
	...
	<script>
		layui.use(['form', 'layedit', 'laydate','laypage'], function() {
			...
			ajax({
				url:"ajax.do?ctrl=jbqkfjdhz_queryInit",
				data:{},
				type:'post',
			...
			form.on('submit(export)',function(){
				...
				console.log(">>>执行导出<<<");
				window.location.href="export.do?ctrl=jbqkfjdhz_export&cxrq="+cxrq
		...
		function getData() {			
			...
			showLoad();
			ajax({
				url:"ajax.do?ctrl=jbqkfjdhz_queryHzbFjd",
				data:{
					"pageNo":pageNo,
					"pageSize":pageSize,
					"cxrq":cxrq,
