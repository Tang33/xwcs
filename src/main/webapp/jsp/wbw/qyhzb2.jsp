...
<body style="overflow-x: hidden">
				...
				<table class="layui-table" id="table" lay-filter="user">
					<thead>
						<tr>
							...
							<th rowspan="2" lay-data="{field:'NSRMC'}">纳税人名称</th>
							<th colspan="4" lay-data="{field:''}">营业收入情况</th>
							<th colspan="4" lay-data="{field:''}">税收情况</th>
							<th rowspan="2" lay-data="{field:'HY_MC'}">行业</th>
							<th rowspan="2" lay-data="{field:'JJLX'}">经济类型</th>
							<th rowspan="2" lay-data="{field:'JD_MC'}">所属街道</th>
						</tr>
						<tr>
							<th lay-data="{field:'YSSRBYLJ'}">本年累计</th>
							<th lay-data="{field:'YSSRSNTQS'}">上年同期</th>
							<th lay-data="{field:'YSSRTBZJE'}">增减率</th>
							<th lay-data="{field:'YYSRSNQNHJ'}">上年累计</th>
							<th lay-data="{field:'SSBNYLJ'}">本年累计</th>
							<th lay-data="{field:'SNSSTQS'}">上年同期</th>
							<th lay-data="{field:'SSTBZJL'}">增减率</th>
							<th lay-data="{field:'SSSNQNHJ'}">上年累计</th>
						</tr>
					</thead>
					<tbody id="ttbody">
	...
	<script>
		layui.use(['form', 'layedit', 'laydate','laypage'], function() {
			...
			ajax({
				url:"ajax.do?ctrl=qyhzb2_queryInit&pageNo=" + pageNo + "&pageSize="
				+ pageSize,
				data:{},
				type:'post',
			...
			form.on('submit(export)',function(){
				...
				console.log(">>>执行导出<<<");
				window.location.href="export.do?ctrl=qyhzb2_export&cxrq="+cxrq
		...
		function getData() {			
			...
			showLoad();
			ajax({
				url:"ajax.do?ctrl=qyhzb2_queryHzb2",
				data:{
					"pageNo":pageNo,
					"pageSize":pageSize,
					"cxrq":cxrq,
