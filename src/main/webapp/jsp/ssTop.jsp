...
<script>
    ...
    function getTable(data) {
      layui.use('table', function(){
        ...
        table.render({
          ...
          ,height: 'auto'
          /* ,data: data //数据 */
          ,url:"${pageContext.request.contextPath}/show/yljAll.do"
          ,cols: [[ //表头
            {field: 'YF', title: '月份',align:'right'}
            ,{field: 'DYLJJE', title: '当月累计金额', align:'right', templet:'#jelj'}
  ...
  //导出
    $("#exportExcel").click(function() {
    	...
    	window.location.href="../expecel/export.do?no=1";
    });
</script>
</html>