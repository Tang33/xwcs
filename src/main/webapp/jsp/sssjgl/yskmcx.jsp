...
<blockquote class="layui-elem-quote layui-text">本功能页面用于对加工后数据按预算科目代码汇总查询！</blockquote>
                                ...
                                <div class="layui-inline">
                                    <div style="text-align: center;">
                                        <button class="layui-btn layui-btn-normal" id="button"
                                                type="button" lay-submit="" lay-filter="button">查询
                                        </button>
        ...
        .use(
            ...
            function () {
                ...
                form.on('submit(exportExcel)',function (data) {
                	window.location.href = "yskmcx/exports.do?"
                    	+ $("#yearNmonth").serialize();
                });
