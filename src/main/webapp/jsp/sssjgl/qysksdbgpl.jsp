...
{{# if(d.QXJ==""||d.QXJ==null||d.QXJ==undefined){ }}
	...
	<div id="xg" style="display: none;">
        ...
        <div class="layui-input-block" style="width: 65%;">
          <!-- <select name="zsxm_dm" id="zsxm_dm">
            <option value="增值税">增值税</option>
            <option value="营改增增值税">营改增增值税</option>
            <option value="营业税">营业税</option>
            <option value="企业所得税">企业所得税</option>
          ...
          <!-- <input type="checkbox" name="sz" title="增值税" lay-skin="primary" value="zzs">
          <input type="checkbox" name="sz" title="营改增增值税" lay-skin="primary" value="ygzzzs"> 
          <input type="checkbox" name="sz" title="营业税" lay-skin="primary" value="yys"> 
          <input type="checkbox" name="sz" title="企业所得税" lay-skin="primary" value="qysds"> 
          <input type="checkbox" name="sz" title="个人所得税" lay-skin="primary" value="grsds"> 
          <input type="checkbox" name="sz" title="车船税" lay-skin="primary" value="ccs"> 
          <input type="checkbox" name="sz" title="房产税" lay-skin="primary" value="fcs"> 
          <input type="checkbox" name="sz" title="印花税" lay-skin="primary" value="yhs"> 
          <input type="checkbox" name="sz" title="城市维建设税" lay-skin="primary" value="cswhjss"> 
          <input type="checkbox" name="sz" title="地方教育附加" lay-skin="primary" value="dfjyfj"> 
          <input type="checkbox" name="sz" title="教育附加" lay-skin="primary" value="jyfj"> 
          <input type="checkbox" name="sz" title="城镇土地使用税" lay-skin="primary" value="cztdsys"> 
          <input type="checkbox" name="sz" title="环保税" lay-skin="primary" value="hbs">  -->
	...
	<script>
		...
		/*  function setAllNo(){
			...
			var loves = document.getElementsByName("sz");
