...
<body>
	...
	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
		<legend>一般公共预算收入增幅前二十（单位：万元）</legend>
...
<script>
    ...
    function getTable(data) {
      layui.use('table', function(){
        ...
        table.render({
          ...
          ,height: 'auto'
          /* ,data: data //数据 */
          ,url:"${pageContext.request.contextPath}/show/ssZFTop.do"
          ,cols: [[ //表头
            {field: 'NSRMC', title: '纳税人名称',align:'right'}
    ...
    $("#exportExcel").click(function() {
    	...
    	window.location.href="../expecel/export.do?no=5";
    });
</script>
</html>