...
<script>
    ...
    function getTable(data) {
      layui.use('table', function(){
        ...
        table.render({
          ...
          ,height: 'auto'
          /* ,data: data //数据 */
          ,url:"${pageContext.request.contextPath}/syqkfx/queryDJZCLXDetail.do"
          ,limit:10
          ,page:true  
          ,cols: [[ //表头
            {field: 'DJZCLX', title: '登记注册类型',align:'center',templet:'#DJZCLX'}
    ...
    $("#exportExcel").click(function() {
    	...
    	window.location.href="../syqkfx/export.do?method=zc";
    });
</script>
</html>