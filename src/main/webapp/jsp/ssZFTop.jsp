...
<script>
    ...
    function getTable(data) {
      layui.use('table', function(){
        ...
        table.render({
          ...
          ,height: 'auto'
          /* ,data: data //数据 */
          ,url:"${pageContext.request.contextPath}/show/szzbAll.do"
          ,cols: [[ //表头
            {field: 'ZSXM_MC', title: '征收项目',align:'right'}
    ...
    $("#exportExcel").click(function() {
    	...
    	window.location.href="../expecel/export.do?no=2";
    });
</script>
</html>