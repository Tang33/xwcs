 	       			   ...
 	       			   // ,limit: da.length
 	       				...
 	       				$('.task-del').click(function() {
 	       					...
 	       					layer.confirm("确定删除吗?删除后不可恢复",{
 	       			       	...
 	       			       	$.ajax({
 	       		 	           url:"sssjjg/sjjg_deleteTable.do",
 	       		 	           data:{
 	       		 	        	   id:id
