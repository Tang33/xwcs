...
<body style="overflow-x: hidden">
	<blockquote class="layui-elem-quote layui-text">本功能页面用于定制查询模板！</blockquote>
	<div class="layui-container" style="margin-top: 15px;">
		<div style="width: 43%; height: 800px; float: left;">
			<div style="width: 100%; border: 1px solid #e6e6e6; height: 61%;">
			...
			<div
				style="width: 100%; border: 1px solid #e6e6e6; height: 36.5%; margin-top: 2.5%;">
				<table class="layui-table" style="margin: 0px;">
					<thead>
						<tr>
				...
				<div style="width: 100%; padding-left: 5%; margin-top: 1.5%;">
		...
		<div
			style="width: 10%; border: 0px solid #e6e6e6; height: 800px; float: left; margin-left: 10px; text-align: center;">
			...
			<form class="layui-form" action="">
				...
				<div
					...
					<button class="button"
						style="color: white; top: 67%; right:5.5%; border-radius: 5px 0px 0px 5px;"
		...
		<div
			style="width: 43%; border: 1px solid #e6e6e6; height: 800px; overflow: auto; float: left; margin-left: 10px;">
