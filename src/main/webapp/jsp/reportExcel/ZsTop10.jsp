...
<script>
		...
		layui.use(['form', 'layedit', 'laydate','laypage'], function() {
			...
			form.on('submit(exportExcel)', function(data) {
				wait = layer.load();
				window.location.href="zsTop/export.do?"+$("#form1").serialize();
			...
			layui.use('table', function(){
				...
				var table = layui.table;
				 table.render({
			          ...
			          page: true,//开启分页
			          cols: [[ //表头
			            {field: 'XH', title: '序号',width : '10%', type: 'numbers'},
			            {field: 'NSRMC', title: '纳税人名称'},
			            {field: 'JDMC', title: '街道'},
			            {field: 'JN', title: '今年地方口径'},
			            {field: 'QN', title: '去年同期地方口径'},
			            {field: 'ZS', title: '增收'}
			          ]],
