...
<script>
		...
		layui.use(['form', 'layedit', 'laydate','laypage'], function() {
			...
			form.on('submit(exportExcel)', function(data) {
				wait = layer.load();
				window.location.href="sbj/export.do?"+$("#form1").serialize();
				...
				var table = layui.table;
				 table.render({
			          ...
			          cols: [[ //表头
			            ...
			            {field: 'ZZS', title: '增值税',width : '5%'},
			            {field: 'YYS', title: '营业税',width : '5%'},
			            {field: 'QYSDS', title: '企业所得税',width : '10%'},
			            {field: 'GRSDS', title: '个人所得税',width : '10%'},
			            {field: 'ZYS', title: '资源税',width : '5%'},
			            {field: 'CSWHJSS', title: '城市维护建设税',width : '10%'},
			            {field: 'FCS', title: '房产税',width : '5%'},
			            {field: 'YHS', title: '印花税',width : '5%'},
			            {field: 'CZTDSYS', title: '城镇土地使用税',width : '10%'},
			            {field: 'TDZZS', title: '土地增值税',width : '10%'},
			            {field: 'CCS', title: '车船税',width : '5%'},
			            {field: 'GDZYS', title: '耕地占用税',width : '10%'},
			            {field: 'JYFJ', title: '教育费附加',width : '10%'},
			            {field: 'DFJYFJ', title: '地方教育附加',width : '10%'},
			            {field: 'WHSYJSF', title: '文化事业建设费',width : '10%'},
			            {field: 'DFZSE', title: '地方口径收入',width : '10%',fixed: 'right'},
			            {field: 'HJ1', title: '一般公共预算收入',width : '10%',fixed: 'right'},
			            {field: 'HJ2', title: '市本级财力',width : '10%',fixed: 'right'}
			          ]],
