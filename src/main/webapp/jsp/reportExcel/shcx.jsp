						...
						<div class="layui-row">
							<div class="layui-col-md12">
								<div class="layui-row layui-col-space10">
									<div class="layui-col-md4" style="width: 23%;">
										<label class="layui-form-label">纳税人名称:</label>
										<div class="layui-input-inline">
											<input style="width: 170%;" type="text" class="layui-input" id="nsrmc"
												name="nsrmc">
										</div>
									</div>
...
<script>
		...
		layui.use(['form', 'layedit', 'laydate','laypage'], function() {
			...
			form.on('submit(exportExcel)', function(data) {
				wait = layer.load();
				window.location.href="shcx/export.do?"+$("#form1").serialize();
				...
				success : function(obj) {
					if (obj != null && obj.data != null) {
						...
						for (var i = 0; i < jdlist.length; i++) {
							str += "<option value='"+jdlist[i].JD_MC+"'>" + jdlist[i].JD_MC + "</option>";
						}
			...
			layui.use('table', function(){
				...
				var table = layui.table;
				 table.render({
			          ...
			          page: true,//开启分页
			          cols: [[ //表头
			            {field: 'SHXYDM_NSRSBH', title: '纳税人识别号',width : '15%'},
			            {field: 'NSRMC', title: '纳税人名称',width : '30%'},
			            {field: 'JDXZ', title: '街道乡镇',width : '15%'},
			            {field: 'ZCZB', title: '注册资本',width : '15%'},
			            {field: 'DJRQ', title: '登记日期',width : '15%'},
			            {field: 'DJZCLX', title: '登记注册类型',width : '15%'},
			            {field: 'HY', title: '行业',width : '15%'},
			            {field: 'ZCDZ', title: '注册地址',width : '25%'},
			            {field: 'JYDZ', title: '经营地址',width : '25%'},
			            {field: 'LRRQ', title: '录入日期',width : '15%'}
			          ]],
