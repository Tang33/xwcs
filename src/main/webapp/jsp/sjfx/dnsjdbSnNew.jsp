											...
											<div class="layui-col-md3">
												<div class="layui-form-item">
													...
													<div class="layui-input-block">
														<select name="interest" lay-filter="aihao" id="oplist">
...
layui.use(['form', 'layedit', 'laydate','laypage'], function() {
	...
	form.on('submit(export)',function(){
		...
		var options=$("#oplist option:selected");
		var optext = options.text();
		window.location.href="export.do?ctrl=dnsjdbSnNew_export&jzTime="+jzTime+"&optext="+optext;
	});
});
	...
	function getData() {
		...
		var options=$("#oplist option:selected");
		var optext = options.text();
		console.log("截止时间:" + jzTime + ",统计口径:" + optext);
		showLoad();
		ajax({
			url : "ajax.do?ctrl=dnsjdbSnNew_dataQuery",
			data : {
				"jzTime": jzTime,
				"optext": optext,
				"pageNo": pageNo,
