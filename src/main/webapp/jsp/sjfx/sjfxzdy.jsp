		...
		<div class="layui-form" lay-filter="test1">
			<div class="layui-collapse" lay-filter="test">
				<div class="layui-colla-item">
					...
					<div class="layui-colla-content  layui-show" style="height: 190px;">
										...
										<div class="layui-row layui-col-space10">   
											<div class="layui-col-md4">
												<div class="layui-form-item">
													<label class="layui-form-label">生效时间起:</label>
													<div class="layui-input-block">
														<input type="text" id="sxsjq" name="sxsjq" required autocomplete="off" class="layui-input">
													</div>
												</div>
											</div>
											<div class="layui-col-md4">
												<div class="layui-form-item">
													<label class="layui-form-label">生效时间止:</label>
													<div class="layui-input-block">
														<input type="text" id="sxsjz" name="sxsjz" required autocomplete="off" class="layui-input">
													</div>
												</div>
											</div>
											<div class="layui-col-md4">
												<div class="layui-form-item">
													...
													<div class="layui-input-block">
														<input type="text" name="title" lay-verify="title"
															autocomplete="off" class="layui-input" id="nsr">
													</div>
												</div>
											</div>
											<div class="layui-col-md4">
											...
											<div class="layui-col-md4">
												<div class="layui-form-item">
													<label class="layui-form-label" style="width: 90px;">税种：</label>
													<div class="layui-input-block">
														<select name="sz" id="sz">
															<option style="display: none" value=''></option>
															<option value="税种1">税种1</option>
															<option value="税种2">税种2</option>
											...
											<div class="layui-col-md4">
												<div class="layui-form-item">
													<label class="layui-form-label" style="width: 90px;">街道：</label>
													<div class="layui-input-block">
														<select name="sz" id="sz">
															<option style="display: none" value=''></option>
											...
											<div class="layui-col-md4">
												<div class="layui-form-item">
													<label class="layui-form-label" style="width: 90px;">行业：</label>
													<div class="layui-input-block">
														<select name="sz" id="sz">
															<option style="display: none" value=''></option>
											...
											<div class="layui-col-md4" style="clear: both;width: 752px;">
												<div class="layui-form-item">
													<label class="layui-form-label" style="width: 90px;">自定义条件：</label>
													<div class="layui-input-block">
														<select id="demo" class="demo" multiple="multiple">
											...
											<div class="layui-col-md2">
												<div style="text-align: center;">
													...
													<div class="layui-btn-group">
														<button class="layui-btn layui-btn-normal" id="create" type="button" lay-submit="" lay-filter="button">生成模板</button>
														<button class="layui-btn layui-btn-normal" id="delete" type="button" lay-submit="" lay-filter="export">删除模版</button>
													</div>
												</div>
											</div>
										</div>
					...
					<div class="layui-colla-content  layui-show" style="height: 40px;">
						<div class="layui-col-md12">
							<div class="layui-row layui-col-space10">   
								<div class="layui-col-md4">
									<div class="layui-form-item">
										<label class="layui-form-label">查询模版:</label>
										<div class="layui-input-block">
											<select id="demo" class="demo" multiple="multiple">
