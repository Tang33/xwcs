...
<script>
    ...
    function getTable(data) {
      layui.use('table', function(){
        ...
        table.render({
          ...
          ,height: 'auto'
          /* ,data: data //数据 */
          ,url:"${pageContext.request.contextPath}/ajax.do?ctrl=syqkfx_queryJDDetail"
          ,cols: [[ //表头
            {field: 'JD', title: '街道类型',align:'center',templet:'#JD'}
    ...
    $("#exportExcel").click(function() {
    	...
    	window.location.href="../export.do?ctrl=expecel2_szzbAll";
    });
</script>
</html>