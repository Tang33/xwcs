...
<body>
	...
	<div
		...
		<a style="color: white;" href="/fast/jsp/login.jsp">登录</a>
	</div>
	<div class="foo"
	...
	<script src="static/js/49f8daee.vendors.js"></script>
	<script src="static/js/26f2fc0d.index.js"></script>
	...
	<script type="text/javascript">
		...
		function test(cname, vString, key, ms, type) {
			...
			var ip = $("#ip").val();
			$(".input").val(ip + "/fast/ajax.do?ctrl=" + cname + "_" + key);
		...
		function ins() {
			...
			$("#val").val(vv);
			var val = $("#val").val();
			var str = "<tr id='tr"+val+"'><td><input type='text' id='kval"+val+"' class='text'  /></td><td><input type='text' id='vval"+val+"' class='text'  /></td><td><button onclick='del(\""
					+ val + "\");'>X</button></td></tr>";
			$("#tab").append(str);
		}
		function del(str) {
				...
				<table
					...
					<thead>
						<tr>
							<th>key</th>
							<th>value</th>
							<th><button onclick='javascript:ins();'>+</button></th>
						</tr>
					</thead>
					<tbody id="tab">
