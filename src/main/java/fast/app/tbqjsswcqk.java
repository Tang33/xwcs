...
public class tbqjsswcqk extends Super{
	...
	public String dataQuery(Map<String, Object> rmap){
		try{
			...
			List<Map<String,Object>> rs = (List<Map<String, Object>>) JdbcConnectedPro.call("SJ_TB_NEW.GRAPHBYJDSSWCQK", list);// 调用存储过程
