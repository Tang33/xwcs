...
public class sjfxzdy extends Super{
	...
	public String dataQuery(Map<String, Object> rmap){
		try{
			...
			String nsrmc = getValue(this.getForm().get("nsr"));// 纳税人名称
			...
			if ("1".equals(pageNum)||counts == null || "".equals(counts)) {
				...
				List<Map<String,Object>> rs = (List<Map<String, Object>>) JdbcConnectedPro.call("SJ_FX_NEW.ANAYBYTQYDSJBD_JLS", list);// 调用存储过程
			...
			list.add(new Mode("OUT","RS",""));
			List<Map<String,Object>> rs1 = (List<Map<String, Object>>) JdbcConnectedPro.call("SJ_FX_NEW.ANAYBYTQYDSJBD", list);// 调用存储过程
	...
	public Object export(Map<String, Object> rmap) {
		try {
			...
			String nsrmc = getValue(this.getForm().get("nsr"));
			...
			list.add(new Mode("IN","String","30000"));
			list.add(new Mode("OUT","RS",""));

			List<Map<String, Object>> sjList= (List<Map<String, Object>>) JdbcConnectedPro.call("SJ_FX_NEW.ANAYBYTQYDSJBD", list);// 调用存储过程
