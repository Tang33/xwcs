...
public class dzcxmb extends Super{
	...
	public String generateMb(Map<String,Object> rmap){
		init(rmap);
		...
		String str = getValue(this.getForm().get("data"));
		try{
			String czy = this.getRequest().getSession().getAttribute("unsame").toString();
