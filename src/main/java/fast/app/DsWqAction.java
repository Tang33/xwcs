...
public class DsWqAction extends Super {
	...
	public String doQuery(Map<String, Object> rmap) {
		try {
			...
			String sql = " select  t.SWGLM as SWGLM,' ' as NSRSBH,t.nsrmc as NSRMC,t.jydz as SCJYDZ ,t.jd_dm as JD_DM,jd.jd_mc as JD_MC,t.LY as LY "
					...
					+ " from DJ_DS_WQSYH t,DM_JD jd "
					+ " where t.jd_dm=jd.jd_dm(+) and trim(t.nsrmc) like '%"
					+ paramNsrmc
	...
	public String doDel(Map<String, Object> rmap){
		try{
			...
			String sql = " Delete from DJ_DS_WQSYH where NSRMC='" + NSRMC + "' ";
			Integer a=this.getBs().update(sql);
	...
	public String doUpdate(Map<String, Object> rmap){
		try{
			...
			String sql = " Update DJ_DS_WQSYH set NSRMC='" + NSRMC
	...
	public String doAdd(Map<String, Object> rmap){
		try{
			...
			String sql = " Insert into DJ_DS_WQSYH(SWGLM,NSRMC,JD_DM,JYDZ,LY,LRRY_DM,LR_SJ) Values('"
					+ SWGLM
					+ "','"
					+ NSRMC
					+ "','"
	...
	public String doQueryCount(Map<String, Object> rmap){
		try{
			...
			String sql1="SELECT * FROM DJ_DS_WQSYH WHERE SWGLM='"+SWGLM+"'";
			String sql2="SELECT * FROM DJ_DS_WQSYH WHERE nsrmc='"+NSRMC+"'";
	...
	public String doDeleteAndInsert(Map<String, Object> rmap){
		try{
			...
			String delSql1="Delete from DJ_DS_WQSYH WHERE SWGLM='" + SWGLM + "' ";
			String delSql2="Delete from DJ_DS_WQSYH WHERE NSRMC='"+NSRMC+"'";
