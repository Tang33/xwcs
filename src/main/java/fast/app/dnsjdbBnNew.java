...
public class dnsjdbBnNew extends Super{
	...
	public String dataQuery(Map<String, Object> rmap){
		try{
			...
			if ("1".equals(pageNum) || counts == null || "".equals(counts)) {
				...
				List<Map<String,Object>> rs = (List<Map<String, Object>>) JdbcConnectedPro.call("sj_cx_2012.ANAYBYDNSJBD_BN_JLS", list);// 调用存储过程
			...
			list.add(new Mode("IN","String",cxkj));
			list.add(new Mode("OUT","RS",""));
			List<Map<String,Object>> rs1 = (List<Map<String, Object>>) JdbcConnectedPro.call("sj_cx_2012.ANAYBYDNSJBD_BN", list);// 调用存储过程
	...
	// 导出excel
			public Object export(Map<String, Object> rmap) {
				try {
					...
					List<Map<String, Object>> sjList= (List<Map<String, Object>>) JdbcConnectedPro.call("sj_cx_2012.ANAYBYDNSJBD_BN", list);// 调用存储过程
					//System.out.println(sjList);

					Map<String, Object> map = new HashMap<String, Object>();
					String[] cols = { "纳税人名称", "年份", "1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月", "截至本月合计", "全年合计"};
					String[] keys = { "NSRMC", "NF", "M01", "M02", "M03", "M04", "M05", "M06", "M07", "M08", "M09", "M10", "M11", "M12", "HJ", "NHJ"};
