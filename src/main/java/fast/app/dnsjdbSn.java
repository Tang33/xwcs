...
public class dnsjdbSn extends Super{
	...
	public String dataQuery(Map<String, Object> rmap){
		try{
			...
			if ("1".equals(pageNum) || counts == null || "".equals(counts)) {
				...
				List<Map<String,Object>> rs = (List<Map<String, Object>>) JdbcConnectedPro.call("sj_cx_2012.EIGHT_ANAYBYDNSJBD_SN_JLS", list);// 调用存储过程
			...
			list.add(new Mode("IN","String",cxkj));
			list.add(new Mode("OUT","RS",""));
			List<Map<String,Object>> rs1 = (List<Map<String, Object>>) JdbcConnectedPro.call("sj_cx_2012.EIGHT_ANAYBYDNSJBD_SN", list);// 调用存储过程
	...
	public Object export(Map<String, Object> rmap) {
		try {
			...
			List<Map<String, Object>> sjList= (List<Map<String, Object>>) JdbcConnectedPro.call("sj_cx_2012.EIGHT_ANAYBYDNSJBD_SN", list);// 调用存储过程
