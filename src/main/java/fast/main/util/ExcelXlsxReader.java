 ...
 * 描述: <br>
 * 类型: JAVA<br>
 * 最近修改时间:2017年11月09日 上午10:00:52<br>
 * 
 * @since 2017年11月09日
 * @author “小涛”
 */
public abstract class ExcelXlsxReader extends DefaultHandler {
    ...
    public String getDataValue(String value, String thisStr) {
        ...
        case NUMBER:
            ...
            break;
        case DATE:
            //获取的日期是一串数字、需要使用此HasDigit方法来过滤第一行的表头、日期类型
            if (HasDigit(value)) {
